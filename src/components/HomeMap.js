...
import {NativeBaseProvider,Button,Icon, View,StyleSheet,
  Image,
...
const HomeMap = (props) => {
  ...
  const [location, setLocation] = useState({latitude: 3.866667,longitude: 11.516667,latitudeDelta: 0.222,longitudeDelta: 0.121 });
  ...
  return (
    ...
    {/* <TouchableOpacity
        ...
        <TouchableOpacity
         ...
         <Ionicons name={'search'} size={46} style={styles.floatingButtonStyle}/>
        </TouchableOpacity>
    </View>
  );
};
